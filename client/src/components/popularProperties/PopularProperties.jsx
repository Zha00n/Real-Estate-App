    ...
    <div className={classes.container}>
      <div className={classes.wrapper}>
        ...
        <div className={classes.properties}>
          <Link to={`/properties?type=beach&province=0&priceRange=1`} className={classes.property}>
            <img src={img1} />
            <div className={classes.quantity}>{beachProperties} properties</div>
            <h5>Beach properties</h5>
          </Link>
          <Link to={`/properties?type=mountain&province=1&priceRange=1`} className={classes.property}>
            <img src={img2} />
            <div className={classes.quantity}>{mountainProperties} properties</div>
            <h5>Mountain properties</h5>
          </Link>
          <Link to={`/properties?type=village&province=2&priceRange=1`} className={classes.property}>
            <img src={img3} />
